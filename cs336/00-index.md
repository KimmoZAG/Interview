...
Stanford CS336《从零构建语言模型》中文课程笔记，覆盖训练、推理、对齐全链路。

---

<div class="grid cards" markdown>

- :material-layers: **基础建模**

    ---

    Tokenizer、Transformer 架构、训练循环，覆盖讲次 01–03。

    [:octicons-arrow-right-24: 课程总览](01-overview-and-tokenization.md)

- :material-memory: **系统优化**

    ---

    GPU、Kernel、并行训练、通信，覆盖讲次 05–08。

    [:octicons-arrow-right-24: GPU 基础](05-gpus.md)

- :material-chart-line: **规模规律**

    ---

    Scaling law、资源预算、超参外推，覆盖讲次 09、11。

    [:octicons-arrow-right-24: Scaling Law 基础](09-scaling-laws-fundamentals.md)

- :material-database: **数据工程**

    ---

    数据来源、过滤、去重、评测，覆盖讲次 12–14。

    [:octicons-arrow-right-24: 数据工程（一）](13-data.md)

- :material-robot: **对齐与 RL**

    ---

    SFT、RLHF、DPO、GRPO、可验证奖励，覆盖讲次 15–17。

    [:octicons-arrow-right-24: 对齐（一）](15-alignment-sft-rlhf.md)
